...
**当前版本：V0.0.4** | C++17 | CMake | 网关 + 开发机平台模拟

## 功能概要

- **召唤上传**：平台召唤 → 网关读本地文件 → 简报 → **逐段**内容上传 + **平台内容确认**（V0.0.4）；**断点续传**（`StartByte`）
- **平台推送**（V0.0.3）：平台推简报 + 内容 → 网关写入已知路径；网关逐段确认；**无断点续传**
...
| 文档 | 说明 |
|------|------|
| [18-业务时序流程.md](document/18-业务时序流程.md) | 召唤 / 推送时序流程图 |
| [10-MQTT本机联调.md](document/10-MQTT本机联调.md) | 开发机平台 + 目标机网关 |
| [17-V0.0.4-验收说明.md](document/17-V0.0.4-验收说明.md) | 召唤内容确认 C1～C3（当前版本验收） |
| [12-V0.0.2-验收说明.md](document/12-V0.0.2-验收说明.md) | 召唤 R3/R4/R5/大文件 |
| [15-V0.0.3-验收说明.md](document/15-V0.0.3-验收说明.md) | 推送 P1～P4 |
| [14-V0.0.3-平台推送.md](document/14-V0.0.3-平台推送.md) | 推送协议与联调 |
| [16-技术总结.md](document/16-技术总结.md) | 算法、编码、功能与技术难点 |
